    ...
    >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
                ...
                >
                    Get In
                    <span className="text-indigo-500 font-medium">Touch</span>
                </motion.h2>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="space-y-6">
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <motion.button
                                  ...
                                  whileTap={{ scale: 0.98 }}
                                  className="w-full bg-indigo-500 hover:bg-indigo-600 disabled:bg-indigo-400 text-white py-4 rounded-xl text-sm uppercase tracking-wider font-medium transition-all duration-300 flex items-center justify-center space-x-2"
                ...
                >
                        ...
                        <div className="space-y-4">
                            {CONTACT_INFO.map((info, index) => (
                                ...
                                >
                                    ...
                                    >
                                        <info.icon size={20} className="text-indigo-500" />
                                    </div>
                    ...
                    >
                        ...
                        >
                            I'm currrently available for freelance projects and full-time oppurtunities.
                        </p>
                    </motion.div>
                </motion.div>
            </div>
                ...
                >
                    ...
                    <motion.button
                      ...
                      className={`px-6 py-3 rounded-full border font-medium transition-all duration-300 ${
                        isDarkMode 
                          ? 'border-gray-600 hover:border-indigo-500 hover:text-indigo-400'
