  ...
  return (
    ...
    >
        ...
        >
            ...
            />
            <div 
              className={`absolute top-40 right-1/3 w-48 h-48 rounded-full blur-3xl opacity-10 ${
            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <motion.p
                          variants={itemVariants}
                          className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} max-w-xl  mx-auto`}
                        >
