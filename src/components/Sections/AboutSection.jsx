    ...
    >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
                ...
                >
                    About
                    <span className="text-indigo-500 font-medium">Me</span>
                </motion.h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    ...
                    >
                        ...
                        >
                            When I'm not coding, you'll find me exploring new frameworks, contributing to open source, or mentoring
                            aspiring developers. I love the constant evolution of web technologies and the endless possibilities they
                            ...
                            {PASSIONS.map((passion, index) => (
                                <motion.div
                                  ...
                                  className={`flex items-center space-x-4 p-4 rounded-xl ${
                                    isDarkMode ? 'bg-gray-800/30 hover:bg-gray-800/50' : 'bg-gray-50/50 hover:bg-gray-100/50'
                                ...
                                >
                                    ...
                                    >
                                        <passion.icon size={20} className='text-indigo-500' />
                                    </div>
                    ...
                    {/* Digital Signature */}
                    <motion.div
                      variants={itemVariants} className="text-center py-8"
                    >
                        <div
                          className={`text-sm ${
                            isDarkMode ? 'text-gray-500' : 'text-gray-600'
                        ...
                        <div className="flex justify-center">
                            <img src="/images/signature.png" alt="Ace Taiwo" className="w-28" />
                        </div>
                        <div className="text-lg font-medium text-indigo-500 mt-2">
                            Ace Taiwo
                        </div>
                    </motion.div>
                </motion.div>
